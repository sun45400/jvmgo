...
func newConstantInfo(tag uint8, constantPool ConstantPool) ConstantInfo{
	...
	case CONSTANT_String: return &ConstantStringInfo{cp: constantPool}
	case CONSTANT_Class: return &ConstantClassInfo{cp: constantPool}
	case CONSTANT_Fieldref: return &ConstantFieldrefInfo{ConstantMemberrefInfo{cp: constantPool}}
	case CONSTANT_Methodref: return &ConstantMethodrefInfo{ConstantMemberrefInfo{cp: constantPool}}
	case CONSTANT_InterfaceMethodref: return &ConstantInterfaceMethodrefInfo{ConstantMemberrefInfo{cp: constantPool}}
